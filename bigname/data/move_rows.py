...
if __name__ == '__main__':
    # for i in range(14):
    #     move_rows(f'bigname/data/profiles2/split_list{i}.db', f'bigname/data/profiles2/split_list{i}.db', 50)
    #     print(f"Moved 50 rows from split_list{i}.db to the end of the table.")
    
    for i in [1, 3, 12]:
        copy_all_rows(f'bigname/data/new_profile0/profile{i}.db', 'bigname/data/profiles/profile_test.db')
